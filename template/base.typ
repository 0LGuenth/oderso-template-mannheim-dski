...
#let project(
  ...
  /// Whether to use the DSKI-specific cover layout with `__cover-info-top`
  /// and `__cover-info-bottom` slots instead of the default cover layout.
  /// Set by adapters. -> bool
  __cover-layout-dski: false,
  /// Content rendered above the title on the DSKI cover layout
  /// (e.g., institution and program name).
  /// Generated by adapters. -> content | none
  __cover-info-top: none,
  /// Content rendered below the title on the DSKI cover layout
  /// (e.g., course of study).
  /// Generated by adapters. -> content | none
  __cover-info-bottom: none,
  ...
  /// Declaration pages (statutory declaration, AI declaration, confidentiality agreement)
  /// rendered right after the coversheet and before the abstracts. Generated by adapters. -> array
  __declarations: (),
  ...
  /// left, the chapter title on the right). When `false`, the header text is
  /// hidden. -> bool
  ...
  // declaration pages (statutory declaration, AI declaration, confidentiality
  // agreement) rendered right after the coversheet, before the abstracts
  {
    set heading(numbering: none)
    for p in __declarations {
      p
    }
  }
    ...
    set page(
      ...
      header: {
        context {
          ...
          // When disabled, hide the text but reserve its space so the header
          // height (and therefore the body margins) stays identical.
          if header-show-chapter {
            header-content
          } else {
            hide(header-content)
          }
